	...
	<div id="sidebar">
			<ul>
				<li class="menubar">학적부
					<ul>
						<% //학생  %>
						<li onclick="location.href='checkStudentInfo.jsp'">개인 정보 조회</li>
						<li onclick="location.href='requestLeaveReturn.jsp'">휴/복학신청</li>
						<% //교수 %>
						<li onclick="location.href='checkProfInfo.jsp'">개인 정보 조회</li>

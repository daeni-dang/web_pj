	...
	<div id="sidebar">
			<ul>
				...
				<li class="menubar">수강신청
					<ul>						
						<li onclick="location.href='checkEvalResult.jsp'">강의 평가 결과 조회</li>
						<% //학생 %>
						<li onclick="location.href='requestLecture.jsp'">수강신청</li>
						<li onclick="location.href='evalLecture.jsp'">강의 평가</li>
						<li onclick="location.href='requestAbsence.jsp'">유교 결석 신청</li>
						<% //교수 %>
						<li onclick="location.href='makeLecture.jsp'">강의 개설</li>
